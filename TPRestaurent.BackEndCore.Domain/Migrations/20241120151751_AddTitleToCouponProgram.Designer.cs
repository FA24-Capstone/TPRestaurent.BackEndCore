...
namespace TPRestaurent.BackEndCore.Domain.Migrations
{
    ...
    [Migration("20241120151751_AddTitleToCouponProgram")]
    partial class AddTitleToCouponProgram
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.Account", b =>
                {
                    ...
                    b.Property<double>("StoreCreditAmount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.CouponProgram", b =>
                {
                    ...
                    b.Property<int>("CouponProgramTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CouponProgramTypeId");
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.EnumModels.CouponProgramType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.EnumModels.OrderAssignedStatus", b =>
                {
                    ...
                    b.ToTable("OrderAssignedStatuses");
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.EnumModels.OrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 7,
                            Name = "AssignedToShipper",
                            VietnameseName = "Đã tiếp nhận đơn"
                        },
                        new
                        {
                            Id = 8,
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.EnumModels.OrderType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            VietnameseName = "Dùng bữa tại quán"
                        });
                });
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.GroupedDishCraft", b =>
                {
                    b.Property<Guid>("GroupedDishCraftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("GroupedDishJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OrderDetailidList")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("GroupedDishCraftId");

                    b.ToTable("GroupedDishCrafts");
                });
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.Invoice", b =>
                {
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.Order", b =>
                {
                    ...
                    b.Property<string>("CancelDeliveryReason")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double?>("ChangeReturned")
                        .HasColumnType("float");
                    ...
                    b.Property<DateTime?>("StartDeliveringTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ValidatingImg")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.OrderAssignedRequest", b =>
                {
                    ...
                    b.ToTable("OrderAssignedRequests");
                });
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.OrderDetail", b =>
                {
                    ...
                    b.Property<DateTime?>("StartProcessingTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.CouponProgram", b =>
                {
                    b.HasOne("TPRestaurent.BackEndCore.Domain.Models.EnumModels.CouponProgramType", "CouponProgramType")
                        .WithMany()
                        .HasForeignKey("CouponProgramTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TPRestaurent.BackEndCore.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("TPRestaurent.BackEndCore.Domain.Models.CustomerInfoAddress", "CustomerInfoAddress")
                        .WithMany()
                    ...
                    b.HasOne("TPRestaurent.BackEndCore.Domain.Models.Account", "Shipper")
                        .WithMany()
                    ...
                    b.Navigation("CustomerInfoAddress");
