...
namespace TPRestaurent.BackEndCore.Application.Contract.IServices
{
    ...
    {
        Task<string> IntroduceAndAskForInfoAsync(string customerName);
        ...
        Task<string> AskForPeopleAndPreferencesAsync(int numberOfPeople, string specialPreferences);
        ...
        Task<string> CollectInfoFromDatabaseAsync(Guid customerId);
        ...
        Task<string> SuggestFoodBasedOnWeatherAsync(string weatherCondition);
        ...
        Task<string> SuggestFoodBasedOnSpecialRequestAsync(string specialRequest);
        ...
        Task<string> AskForAdditionalInfoAsync(string additionalInfo);
        ...
        Task<string> OptimizeSuggestionBasedOnFeedbackAsync(string customerFeedback);
        ...
        Task<string> EndConversationAndAskSatisfactionAsync(string customerName);
        ...
        Task<string> SuggestDrinkAsync(string food);
        ...
        Task<string> AnswerQuestionsAsync(string question);
    }
}
