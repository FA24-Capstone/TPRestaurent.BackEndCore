...
namespace TPRestaurent.BackEndCore.Application.Implementation
{
    public class WorkerService : GenericBackendService
    {
        ...
        public async Task Start()
        {
            ...
            RecurringJob.AddOrUpdate(() => _orderService.CancelOverReservation(), Cron.MinuteInterval(15), vietnamTimeZone);
            ...
            RecurringJob.AddOrUpdate(() => _orderService.RemindOrderReservation(), Cron.MinuteInterval(15), vietnamTimeZone);
        }
    }
}
