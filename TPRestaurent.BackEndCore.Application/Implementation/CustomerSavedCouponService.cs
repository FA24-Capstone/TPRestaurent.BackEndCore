...
namespace TPRestaurent.BackEndCore.Application.Implementation
{
    ...
    {
        private readonly IGenericRepository<CouponProgram> _repository;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;
        private BackEndLogger _logger;
        public CustomerSavedCouponService(IGenericRepository<CouponProgram> repository, IMapper mapper, IUnitOfWork unitOfWork, IServiceProvider service, BackEndLogger logger) : base(service)
        {
