    ...
    public class ComboService : GenericBackendService , IComboService
    {
        ...
        public async Task<AppActionResult> GetComboById(Guid comboId)
        {
            ...
            try
            {
                ...
                var dishComboDb = await dishComboRepository!.GetAllDataByExpression(p => p.ComboOptionSet.ComboId == comboId, 0, 0, null, false, p => p.DishSizeDetail.Dish!.DishItemType, p => p.DishSizeDetail.DishSize, p => p.ComboOptionSet);
